...
* When public launch settings are added, update `launch_config.py`, the YAML examples and the configuration tests. Keep worker-only defaults in `config.py`; do not restore a second public configuration format.
